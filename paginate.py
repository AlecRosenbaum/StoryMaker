...
PREV_PAGES = dict(bootstrap=_bs_prev_page,
                  ...
                  bootstrap4='<li class="page-item"><a class="page-link" href="{0}">{1}</a></li>',
...
CURRENT_PAGES = dict(bootstrap='<li class="active"><a>{0}</a></li>',
                     ...
                     bootstrap4='<li class="page-item active"><a class="page-link">{0}<span class="sr-only">(current)</span></a></li>',
...
GAP_MARKERS = dict(bootstrap='<li class="disabled"><a>...</a></li>',
                   ...
                   <a>...</a></li>',
                   bootstrap4='<li class="page-item disabled"><a class="page-link">...</a></li>',
                   )
...
PREV_DISABLED_PAGES = dict(bootstrap=_bs_prev_disabled_page,
                           ...
                           bootstrap4='<li class="page-item previous disabled unavailable"><a class="page-link">{0}</a></li>',
                           foundation=FA_LINK,
                           )
...
NEXT_DISABLED_PAGES = dict(bootstrap=_bs_next_disabled_page,
                           ...
                           bootstrap4='<li class="list-item next disabled">\<a class="page-link">{0}</a></li>',
                           foundation=FA_LINK,
                           )
...
CSS_LINKS = dict(bootstrap='<div class="pagination{0}{1}"><ul>',
                 ...
                 bootstrap4='<ul class="pagination{0}{1}">',
